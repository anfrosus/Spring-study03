...
public class CommentService {
    ...
    public void createComment(Long postId, CommentRequestDto commentRequestDto) {
        ...
        Member authorMember = memberRepository.findById(authorId).orElseThrow(()-> new IllegalArgumentException("에러")
        );
        //작성된 글
        Post post = postRepsitory.findById(postId).orElseThrow(()-> new IllegalArgumentException("에러"));
